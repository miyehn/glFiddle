...
void Pathtracer::set_mainbuffer_rgb(uint32_t i, vec3 rgb) {
	uint32_t pixel_size = PATHTRACER_OUT_NUM_CHANNELS * PATHTRACER_OUT_SIZE_PER_CHANNEL;
...
{
	uint32_t subimage_offset = width * begin * PATHTRACER_OUT_NUM_CHANNELS * PATHTRACER_OUT_SIZE_PER_CHANNEL;
	uint8_t* data = image_buffer + subimage_offset;
	vk::uploadPixelsToImage(
		data,
		0, begin,
		width, rows,
		PATHTRACER_OUT_NUM_CHANNELS *PATHTRACER_OUT_SIZE_PER_CHANNEL,
